...
st.title("Hi, This is Chatbot Ramon :sunglasses:") # **Modify this based on the title you want in want
...
input_text = st.chat_input("Chat with Ramon powered by Bedrock and LLama 2") # **display a chat input box
if input_text: 
